...
# --- File Paths ---
INPUT_FILE = "/Users/johnesposito/Documents/GitHub/Project-BlueBook-AI-OCR-Correction/OCR Evaluation/Results/gpt4o_mini_eval_output.csv"
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, f"gpt4o_mini_eval_output_avgs_{timestamp}.csv")
