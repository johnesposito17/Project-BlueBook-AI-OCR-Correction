...
# --- File Paths ---
INPUT_FILE = "/Users/johnesposito/Documents/GitHub/Project-BlueBook-AI-OCR-Correction/OCR Evaluation/Results/gemini_2.5_flash_eval_output.csv"
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, f"gemini_2.5_flash_eval_output_avgs_{timestamp}.csv")
