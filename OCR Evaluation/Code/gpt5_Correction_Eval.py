...
Sends OCR text to GPT-5 for correction (3 trials per prompt = 9 corrections per document)
...
OUTPUT_CSV_PATH = "/Users/johnesposito/Documents/GitHub/Project-BlueBook-AI-OCR-Correction/OCR Evaluation/Results/gpt5_eval_output.csv"
